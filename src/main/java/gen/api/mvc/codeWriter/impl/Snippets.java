...
public class Snippets {
	...
	public static JMethod getGetter(JDefinedClass parentClass, JFieldVar variable) {
		String getterName = "get" + StringUtils.capitalize(variable.name());
	...
	public static JMethod getSetter(JDefinedClass parentClass, JFieldVar variable) {
		String setterName = "set" + StringUtils.capitalize(variable.name());
		JMethod setter = BaseElements.getMethod(parentClass, setterName, void.class, JMod.PUBLIC);
